...
add wave -noupdate -expand -group {ID signals} /pipelined_cpu_testbench/dut/id_module/Reg2Loc
add wave -noupdate -expand -group {ID signals} /pipelined_cpu_testbench/dut/id_module/RegWrite
add wave -noupdate -expand -group {ID signals} -radix unsigned /pipelined_cpu_testbench/dut/id_module/Rm
add wave -noupdate -expand -group {ID signals} -radix unsigned /pipelined_cpu_testbench/dut/id_module/Rn
add wave -noupdate -expand -group {ID signals} -radix unsigned /pipelined_cpu_testbench/dut/id_module/Rd_id
add wave -noupdate -expand -group {ID signals} -radix unsigned /pipelined_cpu_testbench/dut/id_module/Rd_wb
add wave -noupdate -expand -group {ID signals} -radix unsigned /pipelined_cpu_testbench/dut/id_module/Ab
add wave -noupdate -expand -group {ID signals} -radix decimal /pipelined_cpu_testbench/dut/id_module/Da
add wave -noupdate -expand -group {ID signals} -radix decimal /pipelined_cpu_testbench/dut/id_module/Db
add wave -noupdate -expand -group {ID signals} -radix decimal /pipelined_cpu_testbench/dut/id_module/Dw
add wave -noupdate -expand -group {ID signals} -radix decimal /pipelined_cpu_testbench/dut/id_module/WBsignal
add wave -noupdate -expand -group {ID signals} /pipelined_cpu_testbench/dut/id_module/BLsignal
...
add wave -noupdate -group {EX signals} -radix decimal /pipelined_cpu_testbench/dut/alu_result_wb
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {104242 ps} 0}
