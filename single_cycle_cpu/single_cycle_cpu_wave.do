...
add wave -noupdate /single_cycle_cpu_testbench/dut/pc
add wave -noupdate /single_cycle_cpu_testbench/dut/id_module/regfile_module/data
add wave -noupdate /single_cycle_cpu_testbench/dut/mem_module/datamem_module/mem
add wave -noupdate /single_cycle_cpu_testbench/dut/alu_result
...
add wave -noupdate -expand -group Branch /single_cycle_cpu_testbench/dut/BR_to_shift
add wave -noupdate -expand -group Branch /single_cycle_cpu_testbench/dut/new_pc2
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2260605 ps} 0}
...
update
WaveRestoreZoom {0 ps} {43824907 ps}
